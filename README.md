...
Click on this link to see the front end of this project [hello-react-front-end](https://github.com/gauravgangwarweb/hello-react-front-end).
...
```sh
 git clone https://github.com/gauravgangwarweb/hello-rails-back-end.git
```
...
Feel free to check the [issues page](https://github.com/gauravgangwarweb/hello-rails-back-end/issues).
